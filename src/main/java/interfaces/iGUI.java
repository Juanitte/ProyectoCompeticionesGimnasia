...
public interface iGUI {
	...
	void muestraMenuAccionesPrueba();			//Este es el menú de acciones de prueba. Tiene 6 opciones: 1 - Agregar Participación. 2 - Buscar Participación. 3 - Mostrar Participaciones. 4 - Modificar Prueba. 5 - Eliminar Prueba. 0 - Salir.
	...
	void muestraMenuGimnastas();				//Este es el menú de gestión de gimnastas. Tiene 4 opciones: 1 - Añadir Gimnasta. 2 - Buscar Gimnasta. 3 - Mostrar Gimnastas. 0 - Salir.
